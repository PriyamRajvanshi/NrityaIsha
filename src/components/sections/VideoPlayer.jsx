          ...
          <div className="relative bg-black rounded-lg overflow-hidden shadow-2xl">
            ...
            <div className="hidden absolute inset-0 bg-gray-800 items-center justify-center">
              <div className="text-center p-4">
                ...
                <p className="text-gray-400 text-sm mb-2">File: {videoSrc}</p>
                <p className="text-gray-400 text-sm">Please check:</p>
                <ul className="text-gray-400 text-sm mt-2 text-left max-w-md mx-auto">
                  <li>• Video file exists in public/videos/ folder</li>
                  <li>• File format is supported (.mp4, .mov, .webm, .ogg)</li>
                  <li>• Browser supports the video format</li>
                  <li className="mt-2 text-yellow-400">Note: .mov works best in Safari. For better compatibility, convert to MP4.</li>
                </ul>
              </div>
            </div>
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 text-white">
                  <p className="text-sm font-medium">Dance Performance</p>
                </div>
              </div>
            </div>
          </div>
